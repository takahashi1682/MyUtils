...
namespace MyUtils.UICommon.UISelectable
{
    ...
    /// UIが選択された時に移動する機能
    /// </summary>
    public class UISelectMover : AbstractUISelectable
    {
        ...
        protected override void Awake()
        {
            ...
            _defaultPosition = TargetRect.localPosition;
        ...
        {
            _startMoveAnimation = TargetRect.DOLocalMove(_selectedPosition, _duration).SetRelative();
            _startMoveAnimation.SetAutoKill(false);
            _startMoveAnimation.SetLink(gameObject);

            _endMoveAnimation = TargetRect.DOLocalMove(_defaultPosition, _duration);
